...
Now we see that
\bea
\mathbb E[R_{t+1}|\pi] &=& \sum_{R_{t+1}, S_{0:T} , A_{0:T-1}} R_{t+1} \Bigg[ \nn
...
&=& \sum_{R_{t+1}, S_{0:t} , A_{0:t}}  R_{t+1} \Bigg[ \nn
&& \qquad \color{red}{\pi(A_0|S_0)} \color{blue}{p(S_0)} \nn
&& \qquad \times \pi(A_{1}|S_{1}) p(S_{1}|S_0,A_0) \nn
&& \qquad \qquad \dots \nn
&&  \qquad \times \pi(A_{t}|S_{t}) p(S_{t}|S_{t-1},A_{t-1}) \nn
...
\ee
however if $k$ is unbounded then this function is unbounded. We thus define a stochastic reward as
\bea
